    ...
    <div className="bg-white rounded-2xl border border-slate-200 shadow-[0_2px_12px_rgba(15,23,42,0.08),0_1px_3px_rgba(15,23,42,0.05)] p-6 space-y-5">
      ...
      <div className="flex items-center justify-between gap-4 pb-4 border-b border-slate-100">
        <div className="flex items-center gap-3">
          ...
          <span className="text-slate-300">/</span>
          <span className="text-[15px] font-mono font-semibold text-blue-700 bg-blue-50 px-2 py-0.5 rounded border border-blue-200">
            {plan.plan_id}
          </span>
        </div>
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5">
        <div className="space-y-1.5 min-w-0">
          <div className="flex flex-wrap items-center gap-2.5">
            <span className="text-[15px] font-mono font-bold px-2.5 py-0.5 rounded-md bg-slate-900 text-white tracking-wider">
              {plan.plan_id}
            </span>
            ...
            {isFeasible && !hasWarnings ? (
              ...
              <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[15px] font-semibold bg-amber-50 text-amber-700 border border-amber-200">
                <AlertTriangle className="w-3.5 h-3.5 text-amber-600 shrink-0" />
                FEASIBLE WITH WARNINGS
              </span>
            ) : (
              <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[15px] font-semibold bg-red-50 text-red-700 border border-red-200">
                <XCircle className="w-3.5 h-3.5 text-red-600 shrink-0" />
                INFEASIBLE ({hardViolationsCount} VIOLATIONS)
              </span>
            )}
            <span className="inline-flex items-center gap-1 text-[12.5px] font-mono text-slate-500 bg-slate-100 px-2 py-0.5 rounded">
          ...
          <p className="text-[15px] text-slate-500 flex items-center gap-2">
        ...
        <div className="flex items-center gap-4 bg-slate-50 border border-slate-200 rounded-xl px-5 py-3 shrink-0">
          <div>
            <span className="block text-[12.5px] font-semibold uppercase tracking-wider text-slate-400">
