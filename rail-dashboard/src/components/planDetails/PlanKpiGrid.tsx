    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-4 shadow-[0_2px_8px_rgba(15,23,42,0.06)]">
        <div className="flex items-center justify-between text-slate-400 mb-2">
          <span className="text-[12.5px] font-semibold uppercase tracking-wider">Scheduled Blocks</span>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-4 shadow-[0_2px_8px_rgba(15,23,42,0.06)]">
        <div className="flex items-center justify-between text-slate-400 mb-2">
          <span className="text-[12.5px] font-semibold uppercase tracking-wider">Total Duration</span>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-4 shadow-[0_2px_8px_rgba(15,23,42,0.06)]">
        <div className="flex items-center justify-between text-slate-400 mb-2">
          <span className="text-[12.5px] font-semibold uppercase tracking-wider">Corridors</span>
          <MapPin className="w-4 h-4 text-emerald-600" />
        </div>
        <div className="text-2xl font-bold font-mono text-slate-900 leading-tight">
          {affectedCorridors.length}
        </div>
        <p className="text-[12.5px] text-slate-400 mt-1 truncate" title={affectedCorridors.join(', ')}>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-4 shadow-[0_2px_8px_rgba(15,23,42,0.06)]">
        <div className="flex items-center justify-between text-slate-400 mb-2">
          <span className="text-[12.5px] font-semibold uppercase tracking-wider">Track Assets</span>
          <Layers className="w-4 h-4 text-cyan-600" />
        </div>
        <div className="text-2xl font-bold font-mono text-slate-900 leading-tight">
          {affectedAssets.length}
        </div>
        <p className="text-[12.5px] text-slate-400 mt-1">Infrastructure units</p>
      </div>
      ...
      >
        <div className="flex items-center justify-between text-slate-400 mb-2">
          <span className="text-[12.5px] font-semibold uppercase tracking-wider">Conflicts</span>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-4 shadow-[0_2px_8px_rgba(15,23,42,0.06)]">
        <div className="flex items-center justify-between text-slate-400 mb-2">
          <span className="text-[12.5px] font-semibold uppercase tracking-wider">Night Shadow</span>
          <Moon className="w-4 h-4 text-purple-600" />
        </div>
        <div className="text-2xl font-bold font-mono text-slate-900 leading-tight">
          {nightShadows}
        </div>
        <p className="text-[12.5px] text-slate-400 mt-1">Minimal disruption slots</p>
      </div>
    </div>
  );
};
