            ...
            <TableBody>
              {paginatedAssets.map((asset) => (
                ...
                >
                  ...
                  <TableCell>
                    {onSelectCorridor ? (
                      <button
                        ...
                        className="font-mono text-[15px] text-blue-600 hover:text-blue-800 font-semibold hover:underline"
                  ...
                  {/* Track Type */}
                  <TableCell>
                    <span className="px-2 py-0.5 rounded text-[12.5px] font-mono font-bold bg-slate-100 text-slate-700 border border-slate-200">
                      {asset.track_type}
                    </span>
                  </TableCell>
                  ...
                  {/* Chainage Span */}
                  <TableCell>
                    <div className="font-mono text-[15px] text-slate-800">
                      <span>{formatKm(asset.start_km)}</span>
                      <span className="text-slate-400 mx-1">→</span>
                      <span>{formatKm(asset.end_km)}</span>
                      <span className="text-[11.5px] text-slate-400 ml-1.5">
                  ...
                  <TableCell>
                    <span
                      className={`font-mono text-[15px] font-bold px-2 py-0.5 rounded ${
