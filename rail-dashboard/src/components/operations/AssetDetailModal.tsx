            ...
            <div className="space-y-2 max-h-56 overflow-y-auto pr-1">
              {assetRequests.map((req) => (
                ...
                >
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      ...
                      {req.linked_defect_id && (
                        <span className="px-1.5 py-0.5 text-[10px] font-mono font-bold bg-amber-100 text-amber-900 rounded">
                  ...
                  <div className="text-blue-600 hover:text-blue-800 flex items-center gap-1 text-xs font-medium">
                    <span>Inspect</span>
