        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              className="w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-[16.5px] text-slate-900 focus:outline-none focus:ring-1 focus:ring-blue-600"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="flex gap-1 pt-1">
              {[60, 90, 120, 180, 240].map((mins) => (
                <button
                  ...
                  className={`px-1.5 py-0.5 text-[11.5px] font-mono rounded border ${
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-[16.5px] text-slate-900 focus:outline-none focus:ring-1 focus:ring-blue-600 font-mono"
              required
            />
          </div>
